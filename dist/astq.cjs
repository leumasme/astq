...
// src/astq.ts
var astq_exports = {};
__export(astq_exports, {
  default: () => ASTQ
});
module.exports = __toCommonJS(astq_exports);
var import_cache_lru = __toESM(require("cache-lru"), 1);
...
// src/astq-query.js
var import_asty = __toESM(require("asty"), 1);
var import_pegjs_util = __toESM(require("pegjs-util"), 1);
...
var ASTQQuery = class {
  ...
  constructor(selector) {
    this.asty = new import_asty.default();
    this.ast = null;
    if (selector)
  ...
  compile(selector, trace) {
    ...
    let result = import_pegjs_util.default.parse(ASTQQueryParse, selector, {
      startRule: "query",
    ...
    if (result.error !== null)
      throw new Error("ASTQ: compile: query parsing failed:\n" + import_pegjs_util.default.errorMessage(result.error, true).replace(/^/mg, "ERROR: "));
    this.ast = result.ast;
    if (trace)
...
var ASTQ = class {
  constructor() {
    ...
    this._cache = new import_cache_lru.default();
  }
  version() {
